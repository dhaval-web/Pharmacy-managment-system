    ...
    <nav class="flex justify-between bg-gray-900 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          ...
          <li><a class="hover:text-gray-200" href="member_view">Stock</a></li>
  ...
  <div class="container max-w-screen-lg mx-auto">
    <div>
       <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
          <p class="font-medium text-lg">Update member</p>
          <hr>
           <br>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <input type="hidden" name="id" value="{{$member->id}}">
                <input type="text" name="name" id="name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="name" />
                
                <input type="text" name="email" id="email" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="email"  />
                
                <input type="text" name="role" id="role" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="role"  />

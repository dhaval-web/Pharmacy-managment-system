...
<div class="flex flex-wrap ">
  <section class="relative mx-auto">
    ...
    <form method="post" action="{{url('member_view')}}">
        @csrf
        <center>
...
<tr>
  ...
  <tbody>
    ...
    <tr>
      <td class="border border-gray-400 px-4 py-2 text-gray-800 ">{{$member->name}}</td>
      <td class="border border-gray-400 px-4 py-2 text-gray-800 ">{{$member->email}}</td>
      <td class="border border-gray-400 px-4 py-2 text-gray-800 ">{{$member->role}}</td>
      <td class="border border-gray-400 px-4 py-2 text-gray-800 ">{{$member->created_at}}</td>

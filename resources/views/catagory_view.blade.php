...
<div class="flex flex-wrap ">
  <section class="relative mx-auto">
    ...
    <form method="post" action="{{url('catagory_view')}}">
    @csrf
        <center>
        ...
        <input type="text" placeholder="search catagory" name="catagory" >
        </th>
    ...
    <tr>
      ...
      <th class="border border-gray-400 px-4 py-2 ">created_at</th>
  ...
  <tbody>
    ...
    <tr>
      <td class="border border-gray-400 px-4 py-2 text-gray-800 ">{{$catagory->catagory}}</td>
      <td class="border border-gray-400 px-4 py-2 text-gray-800">{{$catagory->created_at}}</td>
      
      <td class="border border-gray-400 px-4 py-2 text-gray-800 space-x-4">
      <a href="{{url('edit_catagory')}}/{{$catagory->id}}">
      <i class="fa-solid fa-pen-to-square fa-xl" style="color: #195fd7;"></i>
      </a>
       <a href="{{url('delete-user')}}/{{$catagory->id}}">
